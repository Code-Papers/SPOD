...
def load_results(root_dir_or_dirs, enable_progress=True, enable_monitor=True, verbose=False):
    ...
    for rootdir in rootdirs:
        ...
        aa = sorted(os.walk(rootdir),key=lambda x:x[0])
        for dirname, dirs, files in aa:
            if '-proc' in dirname:
                files[:] = []
                continue
...
def plot_results(
    ...
    '''
    # g2l_dict = {'TDPPO':'beta=0.99', 'min':'min', 'max':'max', 'mean':'mean'}
    # g2l_color = {'beta=0.99': 'yellow', 'min': 'green', 'max': 'red', 'mean': 'blue'}

    # g2l_dict = {'1.0':'1', '0.1':'0.1', 'TDPPO':'0.01', '0.001':'0.001'}
    # g2l_color = {'1': 'yellow', '0.1': 'green', '0.01': 'red', '0.001': 'blue'}

    # g2l_dict = {'0.1':'0.1', 'TDPPO':'0.4', '0.9':'0.9'}
    # g2l_color = {'0.1': 'green', '0.4': 'red', '0.9': 'blue'}

    g2l_dict = {'A2C':'A2C', 'TRPO':'TRPO', 'PPO':'PPO', 'SPODe23': 'SPOD'}
    g2l_color = {'A2C': 'yellow', 'PPO': 'green', 'TRPO': 'red', 'SPOD': 'blue'}

    # g2l_dict = {'0.1':'SPOD', 'noClip':'Without cliped margin', 'NoDTAE':'Without DTAE', 'PPO':'Without entropy'}
    # g2l_color = {'Without entropy': 'yellow', 'Without DTAE': 'green', 'Without cliped margin': 'red', 'SPOD': 'blue'}
